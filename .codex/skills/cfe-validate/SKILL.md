...
```powershell
python ".codex/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src"
python ".codex/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src/Configuration.xml"
```
