...
```powershell
python ".codex/skills/web-info/scripts/web-info.py" <параметры>
```
...
```powershell
# Статус по умолчанию
python ".codex/skills/web-info/scripts/web-info.py"

# Указать путь к Apache
python ".codex/skills/web-info/scripts/web-info.py" -ApachePath "C:\tools\apache24"
```
