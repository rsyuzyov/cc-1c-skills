...
```powershell
python ".codex/skills/epf-validate/scripts/epf-validate.py" -ObjectPath "src/МояОбработка"
python ".codex/skills/epf-validate/scripts/epf-validate.py" -ObjectPath "src/МояОбработка/МояОбработка.xml"
```
