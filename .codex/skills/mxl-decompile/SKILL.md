...
```powershell
powershell.exe -NoProfile -ExecutionPolicy Bypass -File ".codex/skills/mxl-decompile/scripts/mxl-decompile.ps1" -TemplatePath "<путь>/Template.xml" [-OutputPath "<путь>.json"]
```
