...
```powershell
python ".cline/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src"
python ".cline/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src/Configuration.xml"
```
