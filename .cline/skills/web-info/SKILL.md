...
```powershell
python ".cline/skills/web-info/scripts/web-info.py" <параметры>
```
...
```powershell
# Статус по умолчанию
python ".cline/skills/web-info/scripts/web-info.py"

# Указать путь к Apache
python ".cline/skills/web-info/scripts/web-info.py" -ApachePath "C:\tools\apache24"
```
