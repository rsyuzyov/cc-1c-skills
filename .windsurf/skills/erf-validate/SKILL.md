...
```powershell
python ".windsurf/skills/epf-validate/scripts/epf-validate.py" -ObjectPath "src/МойОтчёт"
python ".windsurf/skills/epf-validate/scripts/epf-validate.py" -ObjectPath "src/МойОтчёт/МойОтчёт.xml"
```
