...
```powershell
python ".cursor/skills/epf-validate/scripts/epf-validate.py" -ObjectPath "src/МойОтчёт"
python ".cursor/skills/epf-validate/scripts/epf-validate.py" -ObjectPath "src/МойОтчёт/МойОтчёт.xml"
```
