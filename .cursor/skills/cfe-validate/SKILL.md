...
```powershell
python ".cursor/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src"
python ".cursor/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src/Configuration.xml"
```
