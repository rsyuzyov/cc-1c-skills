...
```powershell
python ".cursor/skills/epf-validate/scripts/epf-validate.py" -ObjectPath "src/МояОбработка"
python ".cursor/skills/epf-validate/scripts/epf-validate.py" -ObjectPath "src/МояОбработка/МояОбработка.xml"
```
