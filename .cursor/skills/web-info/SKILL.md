...
```powershell
python ".cursor/skills/web-info/scripts/web-info.py" <параметры>
```
...
```powershell
# Статус по умолчанию
python ".cursor/skills/web-info/scripts/web-info.py"

# Указать путь к Apache
python ".cursor/skills/web-info/scripts/web-info.py" -ApachePath "C:\tools\apache24"
```
