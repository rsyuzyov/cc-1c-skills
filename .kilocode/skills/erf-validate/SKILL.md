...
```powershell
python ".kilocode/skills/epf-validate/scripts/epf-validate.py" -ObjectPath "src/МойОтчёт"
python ".kilocode/skills/epf-validate/scripts/epf-validate.py" -ObjectPath "src/МойОтчёт/МойОтчёт.xml"
```
