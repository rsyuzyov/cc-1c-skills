...
```powershell
python ".kilocode/skills/epf-validate/scripts/epf-validate.py" -ObjectPath "src/МояОбработка"
python ".kilocode/skills/epf-validate/scripts/epf-validate.py" -ObjectPath "src/МояОбработка/МояОбработка.xml"
```
