...
```powershell
python ".kilocode/skills/web-info/scripts/web-info.py" <параметры>
```
...
```powershell
# Статус по умолчанию
python ".kilocode/skills/web-info/scripts/web-info.py"

# Указать путь к Apache
python ".kilocode/skills/web-info/scripts/web-info.py" -ApachePath "C:\tools\apache24"
```
