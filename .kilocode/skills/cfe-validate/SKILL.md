...
```powershell
python ".kilocode/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src"
python ".kilocode/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src/Configuration.xml"
```
