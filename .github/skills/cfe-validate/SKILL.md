...
```powershell
python ".github/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src"
python ".github/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src/Configuration.xml"
```
