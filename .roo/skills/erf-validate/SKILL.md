...
```powershell
python ".roo/skills/epf-validate/scripts/epf-validate.py" -ObjectPath "src/МойОтчёт"
python ".roo/skills/epf-validate/scripts/epf-validate.py" -ObjectPath "src/МойОтчёт/МойОтчёт.xml"
```
