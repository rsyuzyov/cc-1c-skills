...
```powershell
python ".roo/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src"
python ".roo/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src/Configuration.xml"
```
